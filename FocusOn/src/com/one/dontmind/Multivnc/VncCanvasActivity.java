...
public class VncCanvasActivity extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.VNC_DisConnection:
			new AlertDialog.Builder(this)
			.setMessage(getString(R.string.DisConnection_comment))
	...
	// this is called for unicode symbols like ��	// multiple duplicate key events have occurred in a row, or a complex string is being delivered.
