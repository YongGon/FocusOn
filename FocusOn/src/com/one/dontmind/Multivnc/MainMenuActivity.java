	...
	public void onCreate(Bundle savedInstanceState) {
		...
		goButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				Intent intent = new Intent(com.one.dontmind.Multivnc.MainMenuActivity.this, com.one.dontmind.Multivnc.VncCanvasActivity.class);
		 ...
		 *  show commercial
		 */
		if(Utils.appstarts > 5 && Utils.appstarts % 2 != 0 && settings.getBoolean(Constants.PREFS_KEY_COMMERCIALDLG, true) && savedInstanceState == null)
		{
			AlertDialog.Builder dialog = new AlertDialog.Builder(this);
